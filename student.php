		...
		<fieldset>
			<div class="col-md-12 alert alert-warning text-center" id="mainApplicationdiv">
				...
				<div class="form-group required">
					<label for="RowID" class="col-md-3 control-label">Student Id:</label>
					<div class="col-lg-7 col-md-7">
						<input class="form-control" name="RowID" id="RowID" placeholder="Student Id" type="text"  value="" >
					</div>
				</div>
				<div class="form-group required">
					<label for="Name" class="col-md-3 control-label">Name:<b style="color:red">*</b></label>
					<div class="col-lg-7 col-md-7">
				...
				<div class="form-group required">
					...
					<div class="col-lg-2">
						<textarea type="text" cols="86" rows="4"></textarea>
					</div>
				</div>
